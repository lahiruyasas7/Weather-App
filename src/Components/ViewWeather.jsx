...
function ViewWeather({setView, viewData}) {
   ...
   *
      ...
      <div className="viewweather-description">
        ...
        <img src={`http://openweathermap.org/img/w/${viewData.icon}.png`} className="wether-icon" alt="weather-icon"  />
        </div>
      ...
      <div className="viewcurrent-weather-footer">
        ...
        <div className="con2">
          <p>{viewData.speed}ms {viewData.degree}degree</p>
        </div>
        <div className="con3">
          <p>
